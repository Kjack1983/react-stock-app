...
const useFormatFetchedData = (
    ...
    const [dayAdjOrIntraday] = useState<string[]>(["TIME_SERIES_DAILY_ADJUSTED", "TIME_SERIES_INTRADAY",]);
    ...
    const fetchStockData = async (
        ...
        const response = await fetchStockDataForSymbol(
            symbol,
            size,
            format,
            time
...
export { toggleDataSeries, constructStockData, useFormatFetchedData };
